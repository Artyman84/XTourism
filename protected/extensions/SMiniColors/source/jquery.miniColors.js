	...
	$.extend($.fn, {
		...
		miniColors: function(o, data) {
			...
			var create = function(input, o, data) {
                ...
                trigger.bind('focus.miniColors', function(event) {
                    show(input);
                });

                // Hide on blur
                trigger.bind('blur.miniColors', function(event) {
			...
			var show = function(input) {
				...
				selector.css({
					...
					left: input.is(':visible') ? input.offset().left + parseInt(input.css("width")) - 188 : input.data('trigger').offset().left,
					display: 'none'
