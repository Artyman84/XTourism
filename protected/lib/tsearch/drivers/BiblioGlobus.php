...
class BiblioGlobus extends TOperator {
     ...
     * @var string
     */
    protected $authURL = 'https://login.bgoperator.ru/auth';

    /**
     * @var string
     */
    protected $login = 'artyman';

    /**
     * @var string
     */
    protected $password = 'yG0J0Q%z7A17QkhcmMoPu';
    ...
    protected $urls = array(
        'countries'          => 'http://export.bgoperator.ru/yandex?action=countries', // страны прилета
    ...
    protected function authenticate(){
        $response = $this->getAuthenticateResponse(['login' => $this->login, 'pwd' => $this->password]);
        //\TUtil::LogPre($response, true);
    }
