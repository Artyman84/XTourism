...
/**
 * This is the model class for table "{{directory_dep_cities}}".
 *
 * The followings are the available columns in table '{{directory_dep_cities}}':
 * @property integer $id
 ...
 */
class ArDirDepCities extends ArDirectorySearch {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return '{{directory_dep_cities}}';
    }
    ...
    public function nameUnique($attribute){
        ...
        if( $model !== null ){
            if( $model->id != $this->id ){
                $this->addError($attribute, 'Город вылета с таким названием уже существует.');
            }
        }
    }
     ...
     * @return ArDirDepCities the static model class
     */
