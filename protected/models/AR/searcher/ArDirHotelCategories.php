...
/**
 * This is the model class for table "{{directory_hotel_categories}}".
 *
 * The followings are the available columns in table '{{directory_hotel_categories}}':
 * @property integer $id
 ...
 */
class ArDirHotelCategories extends ArDirectorySearch {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return '{{directory_hotel_categories}}';
    }
