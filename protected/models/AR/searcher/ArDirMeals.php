...
/**
 * This is the model class for table "{{directory_meals}}".
 *
 * The followings are the available columns in table '{{directory_meals}}':
 * @property integer $id
 ...
 */
class ArDirMeals extends ArDirectorySearch {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return '{{directory_meals}}';
    }
    ...
    public function nameUnique($attribute){
        ...
        if( $model !== null ){
            if( $model->id != $this->id ){
                $this->addError($attribute, 'Такой тип питания уже существует.');
            }
        }
    }
