...
/**
 * This is the model class for table "{{operator_dep_cities}}".
 *
 * The followings are the available columns in table '{{operator_dep_cities}}':
 * @property string $id
 ...
 */
class ArOperatorDepCities extends CActiveRecord {
	/**
	 * @return string the associated database table name
	 */
	public function tableName() {
		return '{{operator_dep_cities}}';
	}
	 ...
	 * @return ArOperatorDepCities the static model class
	 */
