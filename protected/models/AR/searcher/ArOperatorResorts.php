...
/**
 * This is the model class for table "{{operator_resorts}}".
 *
 * The followings are the available columns in table '{{operator_resorts}}':
 * @property string $id
 ...
 */
class ArOperatorResorts extends CActiveRecord {
	/**
	 * @return string the associated database table name
	 */
	public function tableName() {
		return '{{operator_resorts}}';
	}
	...
	public function rules() {
		...
		return array(
			...
			array('element_id, country', 'length', 'max'=>20),
			array('directory_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, operator_id, element_id, directory_id, name, country, position, unread, f_deleted', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ArOperatorResorts the static model class
	 */
