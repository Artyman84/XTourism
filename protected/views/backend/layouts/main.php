...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <?php $this->widget('TBackendMenu', ['controller_name' => $this->getId(), 'action_name' => $this->getAction()->getId(), 'userId' => Yii::app()->request->getParam('id')]); ?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-3 col-md-2 sidebar">
                <?php $this->widget('TAdminSidebar', ['controller_name' => $this->getId(), 'action_name' => $this->getAction()->getId()]); ?>
            </div>
            ...
            <?php if(isset($this->breadcrumbs)):?>
                <?php $this->widget('zii.widgets.CBreadcrumbs', array(
                    ...
                    'homeLink' => CHtml::link('<span class="fa fa-home"></span> Главная',  Yii::app()->createUrl('Admin')),
                ));?>
            <?php endif?>
            </div>
            <!-- breadcrumbs -->
