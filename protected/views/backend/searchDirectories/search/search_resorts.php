...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group font-bold input-group-sm">
            <?php echo $form->label($model, 'is_combined', ['class' => 'small']); ?>
            <?php echo $form->dropDownList($model, 'is_combined', ['0' => 'Не комбинированные', '1' => 'Комбинированные'], ['class' => 'form-control', 'empty' => '']); ?>
        </div>
    </div>

    <div class="col-sm-4">
        <div class="form-group font-bold input-group-sm">
            <?php echo $form->label($model, 'parent_id', array('class' => 'small')); ?>
