...
$this->breadcrumbs = [
    ...
    '<span class="fa fa-user"></span> ' . ArUsers::model()->findByPk($model->user_id)->userName() . ' - Настройки витрины'
];

$this->showFlashMessage('showcase_values');

$this->renderPartial('common_views.tour_showcase.values', ['model' => $model, 'user_id' => $model->user_id ]);?>
