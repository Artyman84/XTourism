...
<?php $this->breadcrumbs=array(
    '<span class="fa fa-suitcase i-margin"></span> Неактивные пакеты турагентов'
);?>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                'name' => 'name',
                'type' => 'html',
                'value' => 'CHtml::link($data->name, Yii::app()->createUrl("UsersDraftPackages/edit", ["id"=> $data->id]))',
            ),
...
Yii::app()->clientScript->registerScript(
    ...
    (function($, undefined){
        ...
        var deleteElements = function(ids){
            $.sendRequest("UsersDraftPackages/delete", {ids: ids}, function(){
        ...
        $(function(){
            ...
            $("body").on("click", "div.t-mainActions li a.t-createElement", function(){
                $.showFade();
                window.location.href = "' . Yii::app()->createUrl('UsersDraftPackages/edit') . '";
            });
            ...
            $("body").on("click", "div.t-ownActions li a.t-editElement", function(){
                ...
                window.location.href = "' . Yii::app()->createUrl('UsersDraftPackages/edit') . '/" + id;
            });
