...
?>
    ...
    <div class="panel panel-default" id="toursRequests_declined" style="margin-top: 20px;">
            ...
            'columns' => array(
                ...
                array(
                    ...
                    'filter' => $this->widget('zii.widgets.jui.CJuiDatePicker', [
                        ...
                        'htmlOptions' => [
                            'id' => 'datepicker_created_at_declined',
...
<?  Yii::app()->clientScript->registerScript(
    ...
    ;(function($, undefined){
        ...
        var wrapId = "#toursRequests_declined";

        var getElements = function() {
            var ids = [];
            $("div#toursRequests_declined input.ch-child:checked").each(function(){
        ...
        var deleteElements = function(ids) {
            $.sendRequest("ToursRequests/delete", {ids: ids}, function(rows){
                ...
                $.reCountElements( $("#toursRequests_declined tbody") );
